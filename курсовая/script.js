...
// Обработка формы пробного урока
...
// Дополнительно: защита от пустых изображений (обработчик onerror уже в HTML)
// и небольшая активная подсветка меню при скролле (по желанию)
...
window.addEventListener('scroll', () => {
    ...
    // Можно было бы добавить класс активному пункту меню, но для простоты оставляем так
});